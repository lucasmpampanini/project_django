...
class In205Spider(scrapy.Spider):
    ...
    start_urls = ['https://www.lightinthebox.com/pt/p/xiaomi-mi-a3-global-version-6-088-polegada-celular-4g-4gb-64gb-2-mp-8-mp-48-mp-qualcomm-snapdragon-665-4030-mah-mah_p7506227.html?prm=1.5.1.1']
...
class In202Spider(scrapy.Spider):
    name = "in202"
    allowed_domains = ["lightinthebox.com"]
    start_urls = ['https://www.lightinthebox.com/pt/p/xiaomi-mi-9t-global-version-6-39-polegada-celular-4g-6gb-64gb-8-mp-13-mp-48-mp-qualcomm-snapdragon-730-4000-mah-mah_p7401310.html?prm=1.5.1.1']
