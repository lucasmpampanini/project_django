...
class Xiaomi(models.Model):
    ...
    pricegb_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
    ...
    pricebg_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
    ...
    pricedx_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
    ...
    pricein_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
    ...
    pricemz_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
    ...
    best_price_brl = models.DecimalField(max_digits=15, decimal_places=2, default=Decimal(0))
